...
function setMuseumRow(layer) {
  ...
  return '<div class="feature-row card" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '">' + '<div class="card-header" role="tab" id="heading' + L.stamp(layer) + '">' + '<h6 class="mb-0">' + '<a class="feature-name" data-toggle="collapse" data-parent="#feature-list" href="#collapse' + L.stamp(layer) + '" aria-expanded="false" aria-controls="collaspse' + L.stamp(layer) + '">' + layer.feature.properties.NAME + '</a></h6></div>' + '<div id="collapse' + L.stamp(layer) + '" class="collapse" role="tabpanel" aria-labelledby="heading' + L.stamp(layer) + '"><div class="card-block">' + layer.feature.properties.NAME + '</div></div></div>'
}
