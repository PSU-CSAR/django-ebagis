...
maps_list = views.MapsViewSet.as_view({
    "get": "list",
    "post": "create"
})
maps_detail = views.MapsViewSet.as_view({
    "get": "retrieve",
    "put": "update",
    "patch": "partial_update",
    "delete": "destroy"
})
maps_download = views.MapsViewSet.as_view({
    "get": "download",
})
